...
# Running on Jade
PYTHONPATH=REMOTE_CODE_FOLDER_PATH/event-vec ENV=JADE RUNCONFIGID=41 python3.11 REMOTE_CODE_FOLDER_PATH/event-vec/eventvec/server/entry_points/main.py
