...
# Running on Jade
PYTHONPATH=REMOTE_CODE_FOLDER_PATH/event-vec ENV=JADE RUNCONFIGID=84 python3.11 REMOTE_CODE_FOLDER_PATH/event-vec/eventvec/server/entry_points/main.py

# Running Locally
REQUEST_ID=1234 PROJECT_ID=event-vec RUNCONFIGID=72 ENV=JADE PYTHONPATH=jade_front/event-vec/code/event-vec python3 jade_front/event-vec/code/event-vec/eventvec/server/entry_points/main.py
