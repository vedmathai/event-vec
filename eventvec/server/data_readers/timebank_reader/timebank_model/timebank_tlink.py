...
class TimebankTlink:
    ...
    @staticmethod
    def from_bs_obj(timex, timebank_document):
        ...
        for attrs in attrs2type:
            if attrs[0] in timex.attrs and attrs[1] in timex.attrs:
                attr0 = attrs[0]
                attr1 = attrs[1]
                _type = attrs2type[(attrs[0], attrs[1])]
        function1 = set_fns[_type[0]]
        function2 = set_fns[_type[1:]]
        function1(timex.attrs.get(attr0))
        function2(timex.attrs.get(attr1))
